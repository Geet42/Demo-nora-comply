...
export function EvidenceClient({ obligations }: { obligations: any[] }) {
    ...
    <div className="space-y-4">
      ...
      {obligations.length === 0 ? (
        ...
        <div className="card !bg-coal2 !border-ash overflow-hidden">
          <div className="px-6 py-4 border-b border-ash eyebrow !text-cream2/60">Obligations awaiting evidence</div>
          <div className="divide-y divide-ash/60">
            {obligations.filter((o: any) => o.pct < 100).slice(0, 10).map((o: any) => (
